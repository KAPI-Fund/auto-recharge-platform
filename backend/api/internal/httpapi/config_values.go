...
func normalizeModernConfigValues(input map[string]string) (map[string]string, error) {
	allowed := map[string]bool{
		...
		"kimooxWebhookSecret": true, "kimooxCardBINID": true, "kimooxCardType": true,
	...
	for _, key := range []string{
		...
		"kimoox_base_url", "kimoox_api_key", "kimoox_api_secret", "kimoox_webhook_secret", "kimoox_card_bin_id", "kimoox_card_type",
	...
	canonical := map[string]string{
		...
		"kimooxAPISecret": "kimoox_api_secret", "kimooxWebhookSecret": "kimoox_webhook_secret", "kimooxCardBINID": "kimoox_card_bin_id",
